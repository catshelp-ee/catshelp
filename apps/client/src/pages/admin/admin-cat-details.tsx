...
import { calculateAge, isFutureDate } from '@utils/date-utils.ts';
...
const CatDetails: React.FC<{ selectedCat: Profile }> = ({ selectedCat }) => {
    ...
    return (
        <div className="profile-section">
            ...
            <span className="section-value">{capitalize(selectedCat.mainInfo.gender)}</span>
            ...
            <span className="section-value">{[selectedCat.mainInfo.coatColour, selectedCat.mainInfo.coatLength].filter(Boolean).join(' ')}</span>
            ...
            <span className="section-value">{selectedCat.mainInfo.chronicConditions}</span>

            <span className="section-label">Kui kaua on kass hoiukodus/kassitoas viibinud?</span>
            <span className="section-value">{selectedCat.mainInfo.fosterStayDuration}</span>
            ...
            <span className="section-value">{selectedCat.personalityInfo.likes.join(', ')}</span>
            ...
            <span className="section-value">{selectedCat.personalityInfo.attitudeTowardsCats}</span>

            <span className="section-label">Kuidas suhtub koertesse?</span>
            <span className="section-value">{selectedCat.personalityInfo.attitudeTowardsDogs}</span>

            <span className="section-label">Kuidas suhtub lastesse?</span>
            <span className="section-value">{selectedCat.personalityInfo.attitudeTowardsChildren}</span>

            <span className="section-label">Kuidas ta sobiks toa- või õuekassikas?</span>
            <span className="section-value">{selectedCat.personalityInfo.suitabilityForIndoorOrOutdoor}</span>
        </div>
    );
};
